...
public class ficalExpressionRecorgnition {
    ...
    ficalExpressionRecorgnition(AssetManager assetManager, Context context, String modelPath, int inputSize) throws IOException {
    ...
    public Mat recognizeImage(Mat mat_image){
        ...
        for(int i = 0; i< faceArray.length; i++){
            ...
            Rect roi = new Rect((int)faceArray[i].tl().x, (int)faceArray[i].tl().y, ((int)faceArray[i].br().x)- ((int)faceArray[i].tl().x),
            ...
            Imgproc.putText(mat_image, emotion_s + "(" + emotion_v + ")",
                    new Point((int)faceArray[i].tl().x+10, (int)faceArray[i].tl().y+20), 1,
                    1.5, new Scalar(0,0,255,150), 2);
        }
